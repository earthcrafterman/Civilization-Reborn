	...
	def handleUserResponse(self, eComment, iData1, iData2):
		...
		# if we are demanding something
			...
			if (diploScreen.offerDeal()):
				...
				print "asdf " + str(self.diploScreen.getWhoTradingWith()) + " " + str(gc.getGame().getActivePlayer())
					
				if gc.getGame().getActivePlayer() in [iXiongnu]:
					vic.onPlayerDemandAccepted(gc.getPlayer(self.diploScreen.getWhoTradingWith()), gc.getGame().getActivePlayer())
		...
		# if we are demanding something with the threat of war
			...
			if (diploScreen.offerDeal()):
				...
				print "asdf " + str(gc.getPlayer(self.diploScreen.getWhoTradingWith())) + " " + str(gc.getGame().getActivePlayer())
