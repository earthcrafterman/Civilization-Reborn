...
def getModifier(iPlayer, iModifier):
	...
	if iCivilization in lOrder:
		...
		if (iModifier == iModifierUnitCost or iModifier == iModifierBuildingCost) and utils.getHumanID() != iPlayer:
			...
			return tModifiers[iModifier][lOrder.index(iCivilization)] * 4 / 3
		else:
...
tResearchCost = 			( 140,110,125,125,130,130,110,200,125,120,120,120,105,115,140,120, 85,110, 90, 90,100, 90, 80, 80, 80,100, 85, 80,110, 80, 85, 80, 70, 90, 85,120,120,100, 85, 90, 80, 80, 75, 75, 70, 90, 90, 90, 75, 80, 70, 70,		110,110,110,350,110,110 )
...
tCivicUpkeep = 				( 110,120,110,100,110,140, 70, 80, 70, 75, 80, 80, 80, 80, 90, 80, 80, 90, 80,100,100, 90, 75, 80, 70, 70, 80, 80, 80, 70, 80, 60, 60, 60, 60, 90, 90, 80, 80, 70, 60, 70, 50, 50, 70, 70, 75, 75, 70, 75, 75, 75,	 	 70, 70, 70, 70, 70, 70 )
...
tWonderCost = 				(  80,100, 80, 80, 80,100, 90,100, 85,100,100,100,100, 90,110,100, 90, 90,100, 90, 80, 85, 90, 70, 90,100,100, 90, 90,100, 90, 80, 80, 90, 80, 80, 90, 90,100, 85, 90,100, 90, 70, 70, 90, 90, 90, 80, 90, 80, 80,		150,150,150,100,100,100 )
