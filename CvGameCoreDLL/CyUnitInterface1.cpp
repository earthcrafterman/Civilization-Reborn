...
void CyUnitPythonInterface1(python::class_<CyUnit>& x)
{
	...
	x
		...
		.def("getMadeAttack", &CyUnit::getMadeAttack, "int ()")
		.def("getAttacksPerTurn", &CyUnit::getAttacksPerTurn, "int ()")
		.def("setMadeAttack", &CyUnit::setMadeAttack, "void (int iNewValue)")
		.def("changeMadeAttack", &CyUnit::changeMadeAttack, "void (int iNewValue)")
		.def("isMadeInterception", &CyUnit::isMadeInterception, "bool ()")
		.def("getMadeInterception", &CyUnit::getMadeInterception, "int ()")
		.def("setMadeInterception", &CyUnit::setMadeInterception, "void (int iNewValue)")
		.def("changeMadeInterception", &CyUnit::changeMadeInterception, "void (int iNewValue)")
